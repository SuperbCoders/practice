function ScheduleController($scope, $compile, Visits, Visit, Settings, ValueList) {
...
angular.module('practice.doctor').controller('ScheduleController', ['$scope', '$compile', 'Visits', 'Visit', 'Settings', 'ValueList', ScheduleController]);

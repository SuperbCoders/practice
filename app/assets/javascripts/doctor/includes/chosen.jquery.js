...
(function () {
            ...
            if (option.nodeName.toUpperCase() === "OPTION") {
                if (option.text !== "") {
                    ...
                    this.parsed.push({
                        ...
                        title: option.getAttribute("data-title") || void 0,
    ...
    AbstractChosen = (function () {
        ...
        AbstractChosen.prototype.set_default_values = function () {
            ...
            this.autohide_results_multiple = this.options.autohide_results_multiple != null ? this.options.autohide_results_multiple : void 0;
        ...
        AbstractChosen.prototype.choices_click = function (evt) {
            ...
            if (evt && $(evt.target).hasClass('chzn-choices-arrow')) {
                if (!this.results_showing) {
                    this.results_hide();
    ...
    Chosen = (function (_super) {
            ...
            if (!this.is_disabled) {
                ...
                if (!((evt != null) && ($(evt.target)).hasClass("search-choice-close"))) {
                    if (!this.active_field) {
                        ...
                        evt.preventDefault();
                        this.results_toggle();
                    } else if (this.is_multiple && evt && ($(evt.target).hasClass('chzn-choices-arrow') || $(evt.target).parents(".chzn-choices-arrow").length)) {
                        if (this.results_showing) {
                            this.results_hide();
                        }
                    }
        ...
        Chosen.prototype.container_mouseup = function (evt) {
            if (this.is_multiple && evt.target.nodeName === "ABBR" && !this.is_disabled) {
        ...
        Chosen.prototype.results_build = function () {
            ...
            if (this.is_multiple) {
                ...
                this.selected_item.addClass("chzn-default").find("span").text(this.default_text).attr('class', '').addClass(this.results_data[this.current_selectedIndex].classes);
        ...
        Chosen.prototype.result_select = function (evt) {
            ...
            if (this.result_highlight) {
                ...
                if (this.is_multiple) {
                    ...
                    var chzn = this;
                    setTimeout(function () {
                        chzn.selected_item.find("span").first().text(item.text).attr('class', '').addClass(chzn.results_data[chzn.current_selectedIndex].classes);
                    }, 5);
                }
                if (!(( !this.autohide_results_multiple || evt.metaKey || evt.ctrlKey) && this.is_multiple)) {
                    this.results_hide();
                }
                this.show_search_field_default();
        ...
        Chosen.prototype.keyup_arrow = function () {
            ...
            if (!this.results_showing && !this.is_multiple) {
                ...
                if (prev_sibs.length) {
                    ...
                    if (!this.autohide_results_multiple && this.choices_count() > 0) {
                        this.results_hide();
                    }
                    return this.result_clear_highlight();
                }
